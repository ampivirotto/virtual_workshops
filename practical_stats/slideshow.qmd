...
# Visualizing Data {style="font-size: 60%;"}
...
# Parametric vs. Nonparametric {style="font-size: 90%;"}
...
## Result Interpretations {style="font-size: 80%;"}
